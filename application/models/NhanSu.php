...
//
     ...
     * @return $this
     */
    public function setCongNhat($chamCong = [])
    {
     ...
     * @return $this
     */
    public function setTuyen($phanCong = [])
    {
     ...
     * @return $this
     */
    public function setNangSuat($nangSuat = [])
    {
    ...
    public function getTileBatCap($lx)
    {
        ...
        foreach ($bc as $cap) {
            ...
            if (count($caplv2) == 2 && in_array(strtolower($caplv2[0]), $lx)) {
                return $caplv2[1];
            }
        }
